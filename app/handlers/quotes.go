...
func SetQuotesRoutes(ctx context.Context, cfg config.Config, r *gin.Engine, p ports.QuotesService) {
	//	r.Use(middlewares.Recover())

	r.POST("/api/v3.5/quotes", createQuotes(p))
	r.GET("/api/v3.5/quotes", getAllQuotes(p))
	r.GET("/api/v3.5/quotes/informe", getInfQuotes(p))
	r.GET("/api/v3.5/quotes/:id", getQuotesByID(p))
	r.PATCH("/api/v3.5/quotes/:id", updateQuotes(p))
	r.DELETE("/api/v3.5/quotes/:id", deleteQuotes(p))
}
...
func createQuotes(p ports.QuotesService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var quote models.CreateQuoteReq
...
func updateQuotes(p ports.QuotesService) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		params := c.Params
		var sale models.UpdateQuoteReq
